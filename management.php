...
// 3. جلب بيانات مادة Management فقط
$sql = "SELECT * FROM resources WHERE subject_id = 'management' ORDER BY id DESC";
...
<head>
    ...
    <title>Management - Class Resources Hub</title>
    ...
    <link rel="stylesheet" href="management-styles.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <section class="hero">
        ...
        <p class="hero-subtitle">Master business principles and organizational leadership</p>
    ...
    <?php include 'management-quiz.php'; ?>
