...
$assignments = [];
$all_subject_ids = [];
$sql = "SELECT * FROM resources WHERE subject_id = 'statistics' ORDER BY id DESC";
...
<head>
    ...
    <title>Statistics & Probability - Class Resources Hub</title>
    ...
    <link rel="stylesheet" href="statistics-styles.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <section class="hero">
        <h1 class="hero-title">📊 Statistics & Probability</h1>
        <p class="hero-subtitle">Master statistical analysis and probability theory</p>
    ...
    <?php include 'statistics-quiz.php'; ?>
