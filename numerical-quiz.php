<!-- Quiz Section - Numerical Computing -->
<style>
...
<div class="quiz-modal" id="quizModal">
    <div class="quiz-container">
        <div class="quiz-header">
            <h2 class="quiz-title">📝 Numerical Quiz</h2>
            <button class="quiz-close" onclick="closeQuizModal()">×</button>
        </div>
        <div class="coming-soon-content">
            <span class="coming-soon-icon">🚀</span>
            <p class="coming-soon-text">Coming Soon!</p>
            <p class="coming-soon-subtext">Numerical Computing quiz questions will be added shortly</p>
        </div>
    </div>
</div>
