...
// 3. جلب البيانات الخاصة بمادة Numerical Computing فقط
$sql = "SELECT * FROM resources WHERE subject_id = 'numerical' ORDER BY id DESC";
...
<head>
    ...
    <title>Numerical Computing - Class Resources Hub</title>
    ...
    <link rel="stylesheet" href="numerical-styles.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <section class="hero">
        <h1 class="hero-title">🔢 Numerical Computing</h1>
        <p class="hero-subtitle">Master numerical methods and computational algorithms</p>
    ...
    <?php include 'numerical-quiz.php'; ?>
